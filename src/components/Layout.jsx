            ...
            <div className="md:hidden mt-6 pb-4 space-y-4">
              {navLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="block text-sm text-[#a0a0a0] hover:text-white transition-colors"
      ...
      <footer className="bg-[#0a0a0a] border-t border-[#2a2a2a] py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <h3 className="text-lg font-semibold text-white mb-4">Mescript Labs</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link to="/portfolio" className="text-[#a0a0a0] hover:text-white transition-colors">
                    Portfolio
                  </Link>
                </li>
                <li>
          ...
          <div className="mt-12 pt-8 border-t border-[#2a2a2a] text-center text-sm text-[#666666]">
