...
function buildFallbackDraft(prompt: string, context?: string): AiDraft {
...
async function callAiService(env: Env, prompt: string, context?: string): Promise<AiDraft | null> {
...
async function callOpenAI(env: Env, prompt: string, context?: string): Promise<AiDraft | null> {
...
async function callHuggingFace(env: Env, prompt: string, context?: string): Promise<AiDraft | null> {
...
async function callAnthropic(env: Env, prompt: string, context?: string): Promise<AiDraft | null> {
...
async function generateAiDraft(env: Env, payload: AiGenerateRequest): Promise<AiDraft> {
...
export async function handleAiGenerate(request: Request): Promise<Response> {
  ...
  try {
    const payload = await request.json() as AiGenerateRequest;
...
export async function handleAiApprove(request: Request): Promise<Response> {
  const env = (request as any).env as Env;
  ...
  try {
    const payload = await request.json() as { id?: string; approved?: boolean };
